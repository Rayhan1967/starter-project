...
// Import User model untuk Node.js environment (untuk testing)
if (typeof require !== 'undefined' && typeof module !== 'undefined' && typeof User === 'undefined') {
    // Hanya import jika kita benar-benar di Node.js environment DAN User belum didefinisikan
